...
def run_vllm(
   ...
   # prof.export_chrome_trace("glm4-base.json")
...
def run_hf(
    ...
    print("TY Log: adding FA2")
    llm = AutoModelForCausalLM.from_pretrained(
        model, torch_dtype=torch.float16, attn_implementation="flash_attention_2", trust_remote_code=trust_remote_code)
